...
export default function ScoreDetails({ grading }: { grading: NonNullable<Essay["grading"]> }) {
  return (
    <div className="flex flex-col justify-center flex-1 space-y-3 text-center md:text-left">
      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm font-medium text-gray-700">
